...
public class TestKeyStoreUtils {
    ...
    private static final Logger logger = Logger.getLogger(TestKeyStoreUtils.class.getName());
    ...
    /**
     * Generate an AES Key and store it encrypted by a password in a keystore
     * Store the keystore protected by a password
     */
